...
/**
 * SolTextoCortoFixture
 */
class SolTextoCortoFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'RESPUESTA' => ['type' => 'string', 'length' => '50', 'null' => false, 'default' => null, 'comment' => null, 'precision' => null, 'fixed' => null, 'collate' => null],
        ...
        '_constraints' => [
            ...
            'SOL_PREGUNTA_TCT_FK' => ['type' => 'foreign', 'columns' => ['SOL_PREGUNTA'], 'references' => ['OTS.SOL_PREGUNTA', 'SOL_PREGUNTA'], 'update' => 'setNull', 'delete' => 'cascade', 'length' => []],
            'SOL_SOLICITUD_TCT_FK' => ['type' => 'foreign', 'columns' => ['SEG_USUARIO', 'PRO_CURSO'], 'references' => ['OTS.SOL_SOLICITUD', '1' => ['SEG_USUARIO', 'PRO_CURSO']], 'update' => 'setNull', 'delete' => 'cascade', 'length' => []],
        ],
    ];
