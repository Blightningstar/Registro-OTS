...
CREATE TABLE SOL_RESPUESTA(
    SEG_USUARIO         INTEGER,
    PRO_CURSO           INTEGER,
    SOL_PREGUNTA        INTEGER,
    TIPO                CHAR(11)                DEFAULT 'Texto Corto',
    ACTIVO              CHAR(1)                 DEFAULT '1',
    
    CONSTRAINT  "SOL_RESPUESTA_PK"              PRIMARY KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA),
    CONSTRAINT  "SOL_SOLICITUD_SOL_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO) REFERENCES SOL_SOLICITUD(SEG_USUARIO,PRO_CURSO)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT?? 
    CONSTRAINT  "SOL_PREGUNTA_SOL_FK"           FOREIGN KEY (SOL_PREGUNTA) REFERENCES SOL_PREGUNTA(SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??

    CONSTRAINT  "TIPO_ENUM"                     CHECK(TIPO IN ('Texto Corto','Texto Medio','Texto Largo','Fecha','Numero')),
    CONSTRAINT 	"ACTIVO_SR_BOOL" 			    CHECK(ACTIVO IN ('1','0'))
);
...
CREATE TABLE SOL_TEXTO_CORTO(
    ...
    CONSTRAINT  "SOL_RESPUESTA_TCT_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA) REFERENCES SOL_RESPUESTA(SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??
...
CREATE TABLE SOL_TEXTO_MEDIO(
    ...
    CONSTRAINT  "SOL_RESPUESTA_TMD_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA) REFERENCES SOL_RESPUESTA(SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??
...
CREATE TABLE SOL_TEXTO_LARGO(
    ...
    CONSTRAINT  "SOL_RESPUESTA_TLG_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA) REFERENCES SOL_RESPUESTA(SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??
...
CREATE TABLE SOL_FECHA(
    ...
    CONSTRAINT  "SOL_RESPUESTA_FCH_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA) REFERENCES SOL_RESPUESTA(SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??
...
CREATE TABLE SOL_NUMERO(
    ...
    CONSTRAINT  "SOL_RESPUESTA_NUM_FK"          FOREIGN KEY (SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA) REFERENCES SOL_RESPUESTA(SEG_USUARIO,PRO_CURSO,SOL_PREGUNTA)
                                                    ON DELETE CASCADE, --ON DELETE RESTRICT??
