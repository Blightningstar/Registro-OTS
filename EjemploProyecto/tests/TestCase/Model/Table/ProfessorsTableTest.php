...
class ProfessorsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Professors') ? [] : ['className' => ProfessorsTable::class];
        $this->Professors = TableRegistry::getTableLocator()->get('Professors', $config);
    }
