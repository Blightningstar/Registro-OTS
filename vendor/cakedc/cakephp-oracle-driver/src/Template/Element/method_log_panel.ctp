...
<p class="warning">The following Method objects used <code>CakeDC\OracleDriver\ORM\Method</code> instead of a concrete class:</p>
<ul class="list">
    ...
    <div class="sql-log-panel-query-log">
        ...
        <table cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <?php foreach ($methods as $method): ?>
                <tr>
                    <td><?= SqlFormatter::format($method['method']) ?></td>
                    <td><?= h($method['rows']) ?></td>
                    <td><?= h($method['took']) ?></td>
                </tr>
                <?php endforeach; ?>
